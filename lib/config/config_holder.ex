defmodule ChallengeElixir.Config.ConfigHolder do
  use GenServer
  alias ChallengeElixir.Config.AppConfig
  @table_name :challenge_elixir_config
  ...
  defp load_additional_properties(%AppConfig{} = config) do
    Application.get_env(:challenge_elixir, :config_loaders, [])
...
defmodule ChallengeElixir.Config.ConfigHolder.PropertiesLoaderBehaviour do
  alias ChallengeElixir.Config.AppConfig

defmodule Infrastructure.EntryPoints.RestController.Authentication.Signin.Domain.SignInDTO do
  @moduledoc """
  ...
  defstruct [:email, :password, :context_data]
  ...
  @spec new(String.t(), String.t(), ContextData.t()) ::
          {:ok, t} | {:error, atom}
  def new(email, pass, %ContextData{} = context_data) do
    if is_nil(email) or is_nil(pass) do
